        ...
        try:
            ...
            return TranslationOutcome(
                ...
                detail={
                    ...
                    "mt_tier": getattr(mt_result, "tier", "") or getattr(self.mt, "name", ""),
        ...
        *,
        ...
        try:
            ...
            try:
                for index, sentence in enumerate(sentences):
                    ...
                    yield {
                        ...
                        "mt_tier": getattr(mt_result, "tier", "") if not passthrough else "",
            ...
            yield {
                ...
                "mt_tier": getattr(mt_result, "tier", "") if ('mt_result' in locals() and not passthrough) else "",
                "total_server_ms": round(total_ms, 2),
                "sentence_count": len(sentences),
                "streamed": multi,
